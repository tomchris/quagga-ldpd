...
AC_MSG_RESULT([])
for python2 in python2.7 python2.6 python2.5 python2.4 python2.3 python2.2 python2.1; do
...
AC_DEFUN([AX_PYTHON3],
[AC_MSG_CHECKING(for python3 build information)
AC_MSG_RESULT([])
for python3 in python3.4 python3.3 python3.2 python3.1 python3.0; do
